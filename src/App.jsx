...
// v5.6 GitHub Build Fix: seluruh fitur v3.8-v5.4 dipertahankan. Layout Aset 360 dan komponen responsif dirapikan agar tidak terpotong atau keluar dari kartu.
const APP_VERSION = '5.6.0';
const APP_VERSION_LABEL = 'v5.6';
...
function App() {
  ...
  function exportBackup() { const blob = new Blob([JSON.stringify(state, null, 2)], { type: 'application/json' }); const url = URL.createObjectURL(blob); const anchor = document.createElement('a'); anchor.href = url; anchor.download = `aerizen-v5.6-backup-${today}.json`; anchor.click(); URL.revokeObjectURL(url); }
  ...
  function resetDemo() { setState(initialState); setQueue([]); setNotice('Data demo Aerizen v5.6 dikembalikan ke awal.'); }
