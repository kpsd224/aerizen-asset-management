# Aerizen Asset Management v5.6

## Perbaikan GitHub Build v5.6

- `package-lock.json` sudah memakai registry publik npm, tanpa alamat registry internal.
- GitHub Actions dipasang pada Node.js 22.16.0/npm 10, menggunakan `npm ci`, cache npm, dan retry otomatis.
- `.npmrc` mengunci `https://registry.npmjs.org/`.
- Smoke test, build Vite, build installer Windows, dan upload EXE tetap berjalan berurutan.
- Seluruh fitur dan tampilan v5.5 dipertahankan.
...
- Identitas versi ditampilkan sebagai **Aerizen Asset Management System · v5.6** dan judul aplikasi **Aerizen Asset Management v5.6**.
