# Aerizen v5.6 GitHub Build Fix

## v5.6.0 — GitHub Actions & npm Registry Fix

- Mengganti seluruh URL registry internal pada `package-lock.json` dengan registry publik npm.
- Menambahkan `.npmrc` publik dan retry dependency installation.
- Mengunci Node.js 22.16.0 agar memakai npm 10 yang stabil.
- Mengubah instalasi CI menjadi `npm ci` serta mempertahankan smoke test, build Vite, build installer, dan upload EXE.
- Mempertahankan seluruh fitur, branding, form lengkap, dan perapian UI v5.5.

## v5.6.0 — Complete Invoice & Aerizen Branding
...
- Menampilkan versi v5.6 pada identitas dan judul aplikasi.
